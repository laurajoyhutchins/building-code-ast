...
Chapter ingestion produces private, text-bearing evidence. To generate the source-safe whole-document inventory and validation reports, follow [`build-ibc-2018-corpus.md`](build-ibc-2018-corpus.md).
