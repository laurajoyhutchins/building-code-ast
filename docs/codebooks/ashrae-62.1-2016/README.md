# ASHRAE 62.1-2016 publication root

This file establishes a durable branch point for work specific to ANSI/ASHRAE Standard 62.1-2016.

## Source artifact

- publication key: `ashrae-62.1-2016`
- expected private filename: `ashrae-62_1-2016.pdf`
- observed artifact size: 1,193,586 bytes
...
While this root PR is open, new ASHRAE 62.1-specific work should branch from `root/ashrae-62.1-2016`. After it lands, descendants may be rebased or retargeted onto the merged root.

## Knowledge bootstrap

LORE bootstrap starts from `.lore/tasks/bootstrap-ashrae-62.1-2016-publication.yaml`. Accepted LORE records remain deferred until durable merge evidence exists.

Deciduous handoff metadata:

- semantic ID: `action.establish-ashrae62-1-2016-publication-root`
- node type: `action`
- arc: `parser-families`
- lifecycle while branch-only: `proposed`
- current architecture: `false`
- evidence path: `docs/codebooks/ashrae-62.1-2016/README.md`
